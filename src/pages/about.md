...
Check out the [GitHub repo](https://github.com/antfu/vitesse) for more details. The SSR version of the template is [here](https://github.com/frandiox/vitessedge-template).
